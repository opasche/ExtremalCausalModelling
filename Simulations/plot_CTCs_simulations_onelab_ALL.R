...
for(sims_code in codes_list){
  ...
  #plot(pdif_ctc)
  Sys.sleep(0.5)
  ggsave(paste(sims_code, "_dif_npctc.pdf", sep=""), plot=pdif_ctc, device="pdf", path=save_path, width=Wdif, height=Hdif, units="mm", dpi=300)
  Sys.sleep(0.5)
  ...
  pci <- ggplot(data.frame(Gamma12=ctc12.i, Gamma21=ctc21.i), aes(x=x) ) +
    geom_segment(x=0.5, xend=0.5, y=0, yend=Inf, col="black", size=1) + geom_segment(x=0.5, xend=0.5, y=0, yend=-Inf, col="black", size=1) +
    ...
    expand_limits(x=plot_xlimsi)
  pcih <- ggplot(data.frame(Gamma12=ctc12.ih, Gamma21=ctc21.ih), aes(x=x) ) +
    geom_segment(x=0.75, xend=0.75, y=0, yend=Inf, col="black", size=1) + geom_segment(x=0.75, xend=0.75, y=0, yend=-Inf, col="black", size=1) +
    geom_histogram(aes(x=Gamma12, y=..density..), binwidth=0.005,boundary=1,closed="right", fill=col_v12) +
  ...
  pcc <- ggplot(data.frame(Gamma12=ctc12.c, Gamma21=ctc21.c), aes(x=x) ) +
    geom_segment(x=1, xend=1, y=0, yend=Inf, col="black", size=1) + geom_segment(x=0.75, xend=0.75, y=0, yend=-Inf, col="black", size=1) +
    geom_histogram(aes(x=Gamma12, y=..density..), binwidth=0.005,boundary=1,closed="right", fill=col_v12) +
    ...
    expand_limits(x=plot_xlimsc)
  pcch <- ggplot(data.frame(Gamma12=ctc12.ch, Gamma21=ctc21.ch), aes(x=x) ) +
    geom_segment(x=1, xend=1, y=0, yend=Inf, col="black", size=1) + geom_segment(x=7/8, xend=7/8, y=0, yend=-Inf, col="black", size=1) +
    geom_histogram(aes(x=Gamma12, y=..density..), binwidth=0.005,boundary=1,closed="right", fill=col_v12) +
  ...
  #plot(pvals_ctc)
  Sys.sleep(0.5)
  ggsave(paste(sims_code, "_vals_npctc.pdf", sep=""), plot=pvals_ctc, device="pdf", path=save_path, width=Wvals, height=Hvals, units="mm", dpi=300)
  Sys.sleep(0.5)
  ...
  #plot(pdif_gpdctc)
  Sys.sleep(0.5)
  ggsave(paste(sims_code, "_dif_gpdctc.pdf", sep=""), plot=pdif_gpdctc, device="pdf", path=save_path, width=Wdif, height=Hdif, units="mm", dpi=300)
  Sys.sleep(0.5)
  ...
  #plot(pvals_gpdctc)
  Sys.sleep(0.5)
  ggsave(paste(sims_code, "_vals_gpdctc.pdf", sep=""), plot=pvals_gpdctc, device="pdf", path=save_path, width=Wvals, height=Hvals, units="mm", dpi=300)
  Sys.sleep(0.5)
  ...
  Sys.sleep(0.5)
  ggsave(paste(sims_code, "_dif_pfcorr_lgpdctc.pdf", sep=""), plot=pdif_pfclgpdctc, device="pdf", path=save_path, width=Wdif, height=Hdif, units="mm", dpi=300)
  Sys.sleep(0.5)
  ...
  Sys.sleep(0.5)
  ggsave(paste(sims_code, "_vals_pfcorr_lgpdctc.pdf", sep=""), plot=pvals_pfclgpdctc, device="pdf", path=save_path, width=Wvals, height=Hvals, units="mm", dpi=300)
  Sys.sleep(0.5)
  ...
  Sys.sleep(0.5)
  ggsave(paste(sims_code, "_dif_constr_lgpdctc.pdf", sep=""), plot=pdif_constrlgpdctc, device="pdf", path=save_path, width=Wdif, height=Hdif, units="mm", dpi=300)
  Sys.sleep(0.5)
  ...
  Sys.sleep(0.5)
  ggsave(paste(sims_code, "_vals_constr_lgpdctc.pdf", sep=""), plot=pvals_constrlgpdctc, device="pdf", path=save_path, width=Wvals, height=Hvals, units="mm", dpi=300)
  Sys.sleep(0.5)
